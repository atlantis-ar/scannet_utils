...
NUM_ANNOT_TO_KEEP_IN_PERCENT = 10#18#10 #0.5 
randValue = 100 #1000
randomValHigherThan = (100 - NUM_ANNOT_TO_KEEP_IN_PERCENT)*(randValue/100.0)
...
def main():
    ...
    for filename in sceneList:
        ...
        element = data['info']
        element["description"] = "ScanNet v2 nyu40id dataset - filtered out categories (numClasses=20), filtered out annotations of instances not enough visible and reduced by "+str(NUM_ANNOT_TO_KEEP_IN_PERCENT)+" percent."
        element["year"] = 2021
